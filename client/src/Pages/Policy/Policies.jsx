      ...
      <Stack textAlign={"left"}>
        ...
        <Stack>
          <Stack lineHeight={1.5} fontWeight={600}>
            ...
            <Text>
              ...
              when you leave another comment. These cookes will last for one
              year.
            </Text>
            <Text>
        ...
        <Stack>
          <Stack lineHeight={1.5} fontWeight={600}>
            ...
            <Text>
              Don’t worry we also accept Your Return, Refund or any Replacement
              Genuine Request. For this You can easily contact With us by
              clicking on Button
            </Text>
          </Stack>
        </Stack>
<br/>
  ...
  <Button leftIcon={<FaDiscourse />} colorScheme='teal' variant='solid'>
    How Can I Help You
  </Button>
